...
urlpatterns = [
    ...
    path(
        "<username>/notifications/", views.notifications_page, name="notifications_page"
    ),
    path("<username>/chat/", views.chat_page, name="chat_page"),
    path(
        "<otheruser>/others_profile_page/",
        views.others_profile_page,
        name="others_profile_page",
    ),
    path(
        "<username>/entertainment_feeds/",
        views.entertainment_feeds,
        name="entertainment_feeds",
    ),
